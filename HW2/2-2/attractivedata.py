...
class AttractiveData:
    def __init__(self, train_file, test_file, pretrained_file, max_size, min_freq, batch_size):
        ...
        self.test_data = data.TabularDataset(
            ...
            fields=[('ID', None), ('Headline', self.TEXT), ('Category', self.CATEGORIES_LABEL)]
        )
        ...
        self.testloader = data.BucketIterator(self.test_data, sort=False, batch_size=batch_size, device=self.device, train=False)
